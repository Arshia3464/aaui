...
export default function Page() {
  return (
    <div className="mx-auto max-w-5xl space-y-16 mt-20">
      {/* hero */}
      <section className="relative overflow-hidden rounded-4xl border border-white/10 bg-zinc-900/40 p-8 md:p-12">
        {/* glow */}
        <div className="absolute top-0 left-1/2 h-80 w-80 -translate-x-1/2 rounded-full bg-purple-500/10 blur-3xl" />
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <Link
              ...
              className="
                ...
                font-medium text-black transition-transform
                hover:scale-[1.02]
              "
            >
              شروع آموزش
      ...
      <section className="space-y-8">
        <div>
          ...
          <p className="leading-9 text-zinc-400">
      ...
      <section
        id="install"
        className="rounded-4xl border border-white/10 bg-zinc-900/30 p-8"
      >
        <h2 className="mb-8 text-3xl font-bold">نصب Framer Motion</h2>

        <p className="mb-8 leading-9 text-zinc-400">
        ...
        <div className="space-y-6">
          <div className="overflow-hidden rounded-2xl border border-white/10 bg-black/30">
            ...
            <pre className="overflow-x-auto p-5 text-left text-sm text-zinc-200">
      ...
      <section className="space-y-8">
        ...
        >
          ...
          <pre className="overflow-x-auto p-6 text-sm leading-8 text-zinc-200">
            {`"use client";
...
>
  ...
  ease: "easeOut",
      ...
      {/* important note */}
      <section className="rounded-4xl border border-cyan-500/20 bg-cyan-500/5 p-8">
        ...
        <div
          dir="ltr"
          className="mt-8 overflow-hidden rounded-2xl border border-white/10 bg-black/30"
        >
          <pre className="overflow-x-auto p-6 text-sm text-zinc-200">
            {`"use client";
...
import { motion } from "framer-motion";`}
      ...
      {/* final */}
      <section className="rounded-4xl border border-white/10 bg-zinc-900/30 p-10 text-center">
        <div className="mb-4 text-5xl">♡</div>

        <h2 className="mb-5 text-3xl font-bold">شروع به ساخت انیمیشن کنید</h2>

        <p className="mx-auto max-w-2xl leading-9 text-zinc-400">
